(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["storybook-ui"] = factory(require("react"));
	else
		root["storybook-ui"] = factory(root["React"]);
...
var _excluded = ["loading", "primary", "backgroundColor", "size", "label"];
...
var Button = function Button(_ref) {
  ...
  var mode = loading ? 'storybook-button--loading' : primary ? 'storybook-button--primary' : 'storybook-button--default';
  ...
  }, props), loading ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", {
    className: "storybook-loading-icon"
  }) : null, label);
};
